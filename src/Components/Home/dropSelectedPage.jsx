...
function dropSelectedPage() {
  ...
  const filteredProducts = Popular_Products.filter((product) => {
    ...
    const ratingMatch = selectedRating
      ? product.productReting >= selectedRating
      : true;
      ...
      <div className="container text-center">
        <div className="row mt-5 position-relative">
          ...
          <div className="position-absolute main-benner-div">
            ...
            <div className="mt-3">
              <button className="bnner-div-button border-none">
                Show Now
        ...
        <div className="row mt-5">
          <div className="col-md-3 dropdown">
            <button
              className="btn  border gap-3 d-flex align-items-center"
              type="button"
          ...
          <div className="col-md-2 dropdown">
            <button
              className="btn border d-flex align-items-center gap-3"
              type="button"
              data-bs-toggle="dropdown"
            >
  ...
  <ul class="dropdown-menu">
    ...
    <li><a className="dropdown-item" href="#">Something else here</a></li>
          ...
          <div className="col-md-2 dropdown gap-3 d-flex align-items-center justify-content-between offset-1">
            <button
              className="btn  border gap-4 d-flex align-items-center"
              type="button"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
          ...
          <div className="col-md-2 dropdown gap-3 d-flex align-items-center ">
            <button
              className="btn  border gap-5 d-flex align-items-center"
              type="button"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
        ...
        <div className="row mt-3">
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product) => (
              <div
                className={`col-md-4 col-sm-6 col-12 border position-relative p-3 main_click_box ${
              ...
              >
                ...
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <button
                    type="button"
                    className="btn btn-outline-success popular-produ-img"
                  >
                ...
                <div className="position-absolute activeshowbuttons">
                  <button
                    type="button"
                    className="btn btn-outline-dark popular-produ-img"
                  >
                    <FontAwesomeIcon icon={faHeart} />
                  </button>
                  <button
                    type="button"
                    className="btn btn-outline-dark popular-produ-img mt-2"
                  >
