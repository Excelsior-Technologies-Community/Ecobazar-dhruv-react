                ...
                <div className="container text-center ">
                    <div className="row mt-5">
                        ...
                        <div className="col-md-2 col-sm-4 col-6 mt-5">
                            ...
                            <span className="d-flex mt-1"><b>Shoping Cart</b></span>
                        ...
                        <div className="col-md-2 col-sm-4 col-6 mt-5">
                            ...
                            <span className="d-flex mt-1">Bread & Bakery</span>
                            <span className="d-flex mt-1">Beauty & Health</span>
                        </div>
                        <hr className="hr-row"/>
...
<img src="./Img/Method=Visa.png" alt="" />
